...
export default function Booking() {
  ...
  useEffect(() => {
    if (!isLoading && !isError && tourData?.costFrom) {
          ...
          <div className="flex-1 space-y-6">
            ...
            <div>
              ...
              <ul className="list-disc list-inside text-sm space-y-1">
                ...
                tourData.included.length > 0 ? (
                  tourData.included.map((item: any, index: number) => (
            ...
            <div>
              ...
              <ol className="list-decimal list-inside text-sm space-y-1">
                ...
                tourData.tourPlan.length > 0 ? (
                  tourData.tourPlan.map((plan: any, index: number) => (
              ...
              <div className="space-y-4">
                ...
                <div className="border-t pt-4">
                  <div className="flex justify-between text-sm mb-2">
                    ...
                    <span>
                      ${tourData?.costFrom ? tourData?.costFrom : "N/A"}
                    </span>
                  </div>
                  <div className="flex justify-between text-sm mb-2">
                    <span>Guests:</span>
