  ...
  return (
    <div className="container mx-auto p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        {tourData?.images?.map((image: any, index: any) => (
          <img
            key={index}
            src={image}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
        <div>
          ...
          <ul className="space-y-1">
            {tourData?.amenities?.map((amenity: any, index: any) => (
        ...
        <div>
          ...
          <ul className="space-y-1">
            {tourData?.included?.map((item: any, index: any) => (
              <li key={index} className="flex items-center">
                <span className="text-green-500 mr-2">✓</span>
                {item}
              </li>
        ...
        <div>
          ...
          <ul className="space-y-1">
            {tourData?.excluded?.map((item: any, index: any) => (
              <li key={index} className="flex items-center">
      ...
      <div className="mb-8">
        ...
        <ol className="space-y-2">
          {tourData?.tourPlan?.map((plan: any, index: any) => (
